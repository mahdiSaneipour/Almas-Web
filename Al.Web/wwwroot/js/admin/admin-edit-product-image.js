...
function InsertImages() {
    imageValues.value = imageValues.value.slice(0, -1);
    console.log(imageValues.value)

    if (imageValues.value != "") {
        images = imageValues.value.split(",");
        OtherImages();
    }
    ...
    if(images != "") {
        ...
        for (var x = 0; x < images.length; x++) {
            ...
            a.addEventListener("click", function () {
                ...
                var url = "/Api/Admin/DeleteProductEditImage/" + imgValue + "/" + productId.value;
