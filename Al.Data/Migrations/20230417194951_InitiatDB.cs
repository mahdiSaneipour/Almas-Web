    ...
    public partial class InitiatDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlideBanners", x => x.BannerId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FactorDetails", x => x.FD_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImageAddress = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoldenDiscounts", x => x.GoldenId);
                    table.ForeignKey(
                        name: "FK_GoldenDiscounts_Discounts_DiscountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoldenDiscounts_DiscountId",
                table: "GoldenDiscounts",
                column: "DiscountId");
